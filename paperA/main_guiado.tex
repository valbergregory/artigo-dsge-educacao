...
\guia{As equa\c{c}\~oes est\~ao corretas; escreva a \emph{intui\c{c}\~ao econ\^omica} de cada bloco e justifique as hip\'oteses-chave (por que capital humano financiado publicamente; por que or\c{c}amento equilibrado; o que muda com d\'ivida). Opcional: derive as CPO no ap\^endice na sua nota\c{c}\~ao.}
% =============================================================================
...
\guia{Os n\'umeros v\^em do c\'odigo --- aqui entra sua \emph{interpreta\c{c}\~ao}: por que o investimento cai primeiro, por que o consumo se ajusta com defasagem, e como as magnitudes se comparam \`a literatura brasileira. Uma boa pr\'atica: uma frase-tese por figura.}
% =============================================================================
...
\guia{\textbf{Este \'e o cora\c{c}\~ao do paper --- invista aqui.} Discuta a plausibilidade de $\phi$ confrontando com estimativas de capital p\'ublico produtivo (Bom \& Ligthart) e de retorno da educa\c{c}\~ao. Explore o \emph{limiar de autofinanciamento} como resultado principal e relacione-o ao debate do teto de gasto (EC 95).}
% =============================================================================
...
\guia{Interprete o multiplicador $>1$ e o custo de bem-estar; compare com estimativas de multiplicadores fiscais para o Brasil (ex.: Pires; Cavalcanti \& Silva). Explique por que o gasto \emph{produtivo} difere de uma transfer\^encia.}
% =============================================================================
...
% =============================================================================
\section{Robustez}
\guia{Acrescente as robustezes que julgar necess\'arias e \emph{rode-as}: variar $\beta$, $\delta_h$, $\tau$ e o horizonte; testar persist\^encia do choque. Reporte que o resultado qualitativo se mant\'em.}
% =============================================================================
...
% =============================================================================
\section{Conclus\~ao}
\guia{Feche na sua voz: reafirme a resposta \`a pergunta do t\'itulo, as implica\c{c}\~oes de pol\'itica e a agenda futura (estima\c{c}\~ao bayesiana, d\'ivida p\'ublica, rigidezes).}
% =============================================================================
